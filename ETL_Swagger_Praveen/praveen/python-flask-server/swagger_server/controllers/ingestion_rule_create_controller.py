...
def create_new_avro_file_rules(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        feedcontrolSet = [(data['feedName'], os.path.basename(data['inputFileLocation']), 'AVRO', os.path.dirname(data['inputFileLocation']), 0, '', 'N', 'abc' )]
...
def create_new_delimited_file_rules(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        feedcontrolSet = [(data['feedName'], os.path.basename(data['inputFileLocation']), 'DELIMITED', os.path.dirname(data['inputFileLocation']), 0, '', 'N', '', 'abc' )]
...
def create_new_fixed_file_rules(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        print(data)
        mapperSet = [ ]
        filemetadataInsertSet = [(data['feedName'], os.path.basename(data['inputFileLocation']), 'FIXED', data['columnSeperator']  )]
        print(filemetadataInsertSet)
        feedcontrolSet = [(data['feedName'], os.path.basename(data['inputFileLocation']), 'FIXED', os.path.dirname(data['inputFileLocation']), 0, '', 'N', '', 'abc' )]
        print(mysqlInsert(mapperSet, feedcontrolSet, filemetadataInsertSet)  )
        retValue=mysqlInsert(mapperSet, feedcontrolSet, filemetadataInsertSet)        
    return retValue
...
def create_new_json_file_rules(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        mapperSet = [ ]
        filemetadataInsertSet = []
        feedcontrolSet = [(data['feedName'], os.path.basename(data['inputFileLocation']), 'JSON', os.path.dirname(data['inputFileLocation']), 0, '', 'N', '', 'abc' )]
        retValue=mysqlInsert(mapperSet, feedcontrolSet, filemetadataInsertSet)
    return retValue
...
def create_new_my_sql_rules(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        feedcontrolSet = [(data['feedName'], '', 'MYSQL', '', 0, '', 'N', '', 'abc' )]
        filemetadataInsertSet = []
        retValue=mysqlInsert(mapperSet, feedcontrolSet, filemetadataInsertSet)
    else:
        print("Not a json")
...
def create_new_orc_file_rules(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        mapperSet = [ ]
        filemetadataInsertSet = []
        feedcontrolSet = [(data['feedName'], os.path.basename(data['inputFileLocation']), 'ORC', os.path.dirname(data['inputFileLocation']), 0, '', 'N', '', 'abc' )]
        retValue=mysqlInsert(mapperSet, feedcontrolSet, filemetadataInsertSet)
    return retValue
...
def create_new_parquet_file_rules(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        mapperSet = [ ]
        filemetadataInsertSet = []
        feedcontrolSet = [(data['feedName'], os.path.basename(data['inputFileLocation']), 'PARQUET', os.path.dirname(data['inputFileLocation']), 0, '', 'N', '', 'abc' )]
        retValue=mysqlInsert(mapperSet, feedcontrolSet, filemetadataInsertSet)
    return retValue
